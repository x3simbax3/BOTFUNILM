...
class TmdbMatchingTests(unittest.TestCase):
    ...
    def test_exact_match_beats_popularity(self) -> None:
        ...
        scored = [
            (tmdb.title_relevance_score(r, "Форсаж"), r) for r in (popular, exact)
        ]
    ...
    def test_tokisky_goul_match(self) -> None:
        ...
        score = tmdb.title_relevance_score(result, "Токийский гурь")
        self.assertGreater(score, 300)

    def test_no_match(self) -> None:
        result = {"title": "Дом дракона", "popularity": 50}
        score = tmdb.title_relevance_score(result, "Форсаж")
    ...
    def test_word_overlap(self) -> None:
        ...
        score = tmdb.title_relevance_score(result, "Матрица")
    ...
    def test_one_shared_word_does_not_make_long_query_relevant(self) -> None:
        ...
        score = tmdb.title_relevance_score(
            result,
    ...
    def test_filter_anime_with_genre_ids(self) -> None:
        ...
        self.assertEqual(len(tmdb.filter_by_content_type(results, "anime")), 1)
    ...
    def test_filter_anime_without_genre_ids_uses_language(self) -> None:
        ...
        filtered = tmdb.filter_by_content_type(results, "anime")
    ...
    def test_filter_cartoon(self) -> None:
        ...
        self.assertEqual(len(tmdb.filter_by_content_type(results, "cartoon")), 1)
    ...
    def test_filter_movie_excludes_animation(self) -> None:
        ...
        self.assertEqual(len(tmdb.filter_by_content_type(results, "movie")), 1)
    ...
    def test_is_anime_without_genre_ids_ja(self) -> None:
        self.assertTrue(tmdb.is_anime({"original_language": "ja"}))

    def test_is_anime_without_genre_ids_non_ja(self) -> None:
        self.assertFalse(tmdb.is_anime({"original_language": "en"}))

    def test_is_animation_without_genre_ids(self) -> None:
        self.assertFalse(tmdb.is_animation({"original_language": "ja"}))
