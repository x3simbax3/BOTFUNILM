...
до ближайшего запуска: обновление каталога в 02:00 или рассылка в 12:00 по
`Europe/Moscow`. SQLite `CURRENT_TIMESTAMP` остаётся в UTC; московская зона
используется только при выборе следующего момента запуска.
